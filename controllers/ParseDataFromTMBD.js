...
class ParseDataFromTMBD {
    ...
    getGenres = async (req, res, isNeedResponse = true) => {
        try {
    ...
    getLanguages = async (req, res, isNeedResponse = true) => {
        try {
    ...
    getFilms = async (req, res, isNeedResponse = true) => {
        try {
            for (let i = 1; i <= 5; i++) {
